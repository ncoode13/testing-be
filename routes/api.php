...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::prefix('attendance')->group(function () {
            ...
            Route::get('/rewards/winners', [AttendanceController::class, 'getRewardWinners']);
            Route::post('/rewards/winners', [AttendanceController::class, 'saveRewardWinners']);
            Route::delete('/rewards/winners/{id}', [AttendanceController::class, 'deleteRewardWinner']);
